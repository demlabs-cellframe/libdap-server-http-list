...
#define LOG_TAG "ServerListModule"
...
int server_list_module_init(const char * servers_list_path)
{
...
void server_list_module_deinit()
{
    //config_destroy(&cfg);
...
void server_list_add_proc(dap_http_t *sh, const char *url)
{
